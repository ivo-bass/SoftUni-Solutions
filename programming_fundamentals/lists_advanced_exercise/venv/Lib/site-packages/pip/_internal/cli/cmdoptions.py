...
def find_links():
    ...
    return Option(
        ...
        help="If a URL or path to an html file, then parse for links to "
             ...
             "Links to VCS project_new URLs are not supported.",
    )
...
def editable():
    ...
    return Option(
        ...
        default=[],
        metavar='path/url',
        help=('Install a project_new in editable mode (i.e. setuptools '
              '"develop mode") from a local project_new path or a VCS url.'),
    )
