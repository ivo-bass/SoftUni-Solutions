...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def name(self):
        # type: () -> str
        """The normalised name of the project_new the candidate refers to"""
    ...
    def _check_metadata_consistency(self):
        # type: () -> None
        """Check for consistency of project_new name and version of dist."""
...
class ExtrasCandidate(Candidate):
    ...
    Requirements can be for a project_new with dependencies, something like
    foo[extra].  The extras don't affect the project_new/version being installed
