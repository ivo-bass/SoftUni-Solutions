...
class Metadata(object):
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.project_new', 'project_urls', 'Home'): 'Home-page',
        ('extensions', 'python.project_new', 'contacts', 0, 'name'): 'Author',
        ('extensions', 'python.project_new', 'contacts', 0, 'email'): 'Author-email',
